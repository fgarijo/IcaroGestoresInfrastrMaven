package org.icaro.infraestructura.patronAgenteReactivo.factoriaEInterfaces;
...
import org.icaro.infraestructura.patronAgenteReactivo.factoriaEInterfaces.imp.FactoriaAgenteReactivoImp;
...
public abstract class FactoriaAgenteReactivo  extends FactoriaComponenteIcaro{
 ...
 protected Logger logger = Logger.getLogger(this.getClass().getCanonicalName());
    ...
    public static FactoriaAgenteReactivo instancia(){
        ...
        if(instancia==null){
            String clase = System.getProperty("org.icaro.infraestructura.patronAgenteReactivo.factoriaEInterfaces.imp",
                    "org.icaro.infraestructura.patronAgenteReactivo.factoriaEInterfaces.imp.FactoriaAgenteReactivoInputObjImp0");
            try{
